...
export default function Verification({ stacked = false }: { stacked?: boolean }) {
  return (
    <div className={stacked ? 'flex flex-col gap-6 md:gap-8' : 'grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-10'}>
      <div className="border-t border-fg/15 pt-5 md:pt-6">
        <h3 className="pixel-serif text-fg text-lg md:text-xl mb-3">Signed Receipts</h3>
        <p className="pixel-sans text-fg-70 text-sm leading-relaxed">
      ...
      <div className="border-t border-fg/15 pt-5 md:pt-6">
        <h3 className="pixel-serif text-fg text-lg md:text-xl mb-3">Lossless Verify + Spot-Checks</h3>
        <p className="pixel-sans text-fg-70 text-sm leading-relaxed">
      ...
      <div className="border-t border-fg/15 pt-5 md:pt-6">
        <div className="flex items-center gap-2 mb-3">
          <h3 className="pixel-serif text-fg text-lg md:text-xl">Reputation, Staking &amp; Slashing</h3>
