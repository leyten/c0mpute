...
// V1 "Studio" — the baseline layout: persistent sidebar with history and
// network status, slim header with credit chips, centered conversation
// column, panel composer. This is the previous page composition wrapped
// into the shell contract, unchanged in behavior.
...
export default function StudioShell(props: ChatShellProps) {
  const {
    activeChat, selectedPlanObj, showScrollDown, onScrollToBottom,
  } = props;
