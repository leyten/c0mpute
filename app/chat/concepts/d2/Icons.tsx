...
export function IconTag({ className }: { className?: string }) {
  return (
    <svg {...svgProps(className)}>
      <path d="M12.586 2.586A2 2 0 0 0 11.172 2H4a2 2 0 0 0-2 2v7.172a2 2 0 0 0 .586 1.414l8.704 8.704a1.5 1.5 0 0 0 2.122 0l6.344-6.344a1.5 1.5 0 0 0 0-2.122z" />
