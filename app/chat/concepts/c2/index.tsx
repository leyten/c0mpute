...
// Concept 2 — "The desk". Chat as a workspace: the library of conversations
// IS the home screen, a conversation is a place you enter and come back from.
// This file owns all product state (desk records, the one live job, errors,
// drafts) on top of useChatEngine, which is the entire backend surface.
