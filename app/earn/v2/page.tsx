...
// Variant 2 — ONE AT A TIME. A single centred panel with a segmented control
// above it. Only the way you picked is on screen, so the page stays small and
// each way gets room for its full setup: requirements, install help, command.
...
export default function EarnOneAtATime() {
