...
`,A=g.styled.button`
  ${z}
`;a.s(["DoubleIconWrapper",()=>r,"LinkButton",()=>t,"LinkPasskeyScreen",()=>q,"LinkPasskeyView",()=>m,"default",()=>q],452520)},965371,a=>{"use strict";var b=a.i(187924),c=a.i(591455),d=a.i(215076);function e({title:a}){let{currentScreen:e,navigateBack:f,navigate:g,data:h,setModalData:i}=(0,c.a)();return(0,b.jsx)(d.M,{title:a,backFn:"ManualTransferScreen"===e?f:e===h?.funding?.methodScreen?h.funding.comingFromSendTransactionScreen?()=>g("SendTransactionScreen"):void 0:h?.funding?.methodScreen?()=>{let a=h.funding;a.usingDefaultFundingMethod&&(a.usingDefaultFundingMethod=!1),i({funding:a,solanaFundingData:h?.solanaFundingData}),g(a.methodScreen)}:void 0})}a.s(["t",()=>e])},689813,a=>{"use strict";var b=a.i(775716),c=a.i(215076),d=a.i(452520);let e=b.styled.div`
  display: flex;
  flex-direction: column;
  gap: 12px;
  padding-top: 24px;
