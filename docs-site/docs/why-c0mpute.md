---
sidebar_position: 2
title: Why Compute Network matters
---

# Why Compute Network matters
...
Compute Network is different, and the privacy comes from two things working together:
...
This isn't theoretical. Compute Network is running now. [Start using it](/user-guide/getting-started) or [become a worker](/worker-guide/browser-worker).
