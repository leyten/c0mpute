...
export declare const DEFAULT_MODEL_REPO = "bartowski/Qwen2.5-14B-Instruct-GGUF";
/** Default GGUF filename */
export declare const DEFAULT_MODEL_FILENAME = "Qwen2.5-14B-Instruct-Q4_K_M.gguf";
/** Human-readable model name sent to orchestrator */
export declare const DEFAULT_MODEL_NAME = "qwen2.5-14b-instruct-q4_K_M";
